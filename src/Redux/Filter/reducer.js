...
const initialState = {
    name: '', minConfirmed: 0, maxConfirmed: 100000000,
    tempName: '', tempMinConfirmed: 0, tempMaxConfirmed: 100000000
};
...
function filterReducer(state = initialState, action) {
    switch (action.type) {
        ...
        case type.CANCEL_FILTER: {
            const { 
                name: tempName, 
                minConfirmed: tempMinConfirmed, 
                maxConfirmed: tempMaxConfirmed
            } = state;
            return {
                ...state,
                tempName, tempMinConfirmed, tempMaxConfirmed
            };
        }

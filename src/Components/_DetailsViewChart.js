...
function DetailsViewChart(props) {
  ...
  return (
    <ResponsiveContainer width="100%" height={chartOptions.height}>
      <BarChart data={data} margin={chartOptions.margin} barCategoryGap="30%">
        <CartesianGrid vertical={false} strokeDasharray="4 4" stroke={chartOptions.dashColor} />
        <XAxis
          dataKey={xAxisKey}
        ...
        />
        <Bar dataKey={dataKey} fill={chartOptions.barColor[mapKey]} />
      </BarChart>
    </ResponsiveContainer>
  );
}
